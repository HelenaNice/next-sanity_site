...
export default async function Home() {
  ...
  return (
    <div>
      <h1 className="text-7xl font-extrabold">Привет,Я
        <span className="bg-gradient-to-r from-orange-400 via-red-500 to-purple-600 bg-clip-text text-transparent"> Алена!</span>
      </h1>
      ...
      <h2 className="mt-24 font-bold text-gray-700 text-3xl">Мои проекты</h2>
